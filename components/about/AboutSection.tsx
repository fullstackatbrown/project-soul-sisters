    ...
    return (
        <div className="bg-neutral-900 text-white min-h-screen w-full flex flex-col md:flex-row items-center p-10 space-y-10">
            ...
            <div className="flex flex-col space-y-10 max-w-xl" 
                    style={{ marginLeft: '2%', marginRight: '2%', marginTop: '10%', flexGrow: 1 }}>
                <h2 className="text-2xl font-bold text-left mb-4 ml-4">
                    {title}
                </h2>
            ...
            <div className="md:w-2/5" style={{ marginLeft: 'auto' }}>
                <img 
                    src={image} 
                    alt="film-picture" 
